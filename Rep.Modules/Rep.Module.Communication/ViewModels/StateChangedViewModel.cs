...
{
    internal class StateChangedViewModel : BindableBase
    {
        #region Propertys
        ...
        public StateChangedViewModel(IEventAggregator aggregator)
        {
            _aggregator = aggregator;
            _aggregator.GetEvent<MessageEvent>().Subscribe(MessageHandle, arg => arg.Type.ToUpper() == "STATECHANGED");
        }
