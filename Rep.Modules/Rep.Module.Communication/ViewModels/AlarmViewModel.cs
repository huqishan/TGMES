...
{
    internal class AlarmViewModel:BindableBase
    {
        #region Propertys
        ...
        public AlarmViewModel(IEventAggregator aggregator)
        {
            _aggregator = aggregator;
            _aggregator.GetEvent<MessageEvent>().Subscribe(MessageHandle,arg=>arg.Type.ToUpper()=="ALARM");
        }
