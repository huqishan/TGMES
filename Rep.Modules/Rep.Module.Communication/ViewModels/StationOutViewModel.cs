...
{
    internal class StationOutViewModel : BindableBase
    {
        #region Propertys
        ...
        public StationOutViewModel(IEventAggregator aggregator)
        {
            _aggregator = aggregator;
            _aggregator.GetEvent<MessageEvent>().Subscribe(MessageHandle, arg => arg.Type.ToUpper() == "STATIONOUT");
        }
